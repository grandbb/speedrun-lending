...
**This extension is one of the Speedrun Ethereum challenges.** It covers **Over-Collateralized Lending**.
...
The deploy script (`packages/hardhat/deploy/00_deploy_contracts.ts`) performs the following in order:
1. Deploy `Corn` token.
